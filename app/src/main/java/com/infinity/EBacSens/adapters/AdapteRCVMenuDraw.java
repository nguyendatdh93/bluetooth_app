...
public class AdapteRCVMenuDraw extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<Sensor> arrItem;
    private Context context;
    private ViewRCVMenuDrawListener callback;

    public AdapteRCVMenuDraw(Context context , ArrayList<Sensor> arrItem , ViewRCVMenuDrawListener callback) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHodler.btnToggle.setTextColor(arrItem.get(position).isToggle() ? context.getResources().getColor(R.color.toggle_text_active) :  context.getResources().getColor(R.color.toggle_text_not_active));
