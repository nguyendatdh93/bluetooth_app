            ...
            case 4:
                ...
                if (statusButton == 1) {
                    ...
                    if (arrRules.size() == 0) {
                        ...
                        edtEqp1.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqt1.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqp2.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqt2.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqp3.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqt3.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqp4.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqt4.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqp5.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEqt5.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtStp.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtEnp.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtPp.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtDlte.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtPwd.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtPtm.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtIbst.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtIben.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
                        edtIfst.setText(String.valueOf(Protector.tryParseHex(arrResults.get(pos++))));
