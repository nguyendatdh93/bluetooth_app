...
public interface DataClient {
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[1][pkpot]") int measres1pkpot,
            @Field("measres[1][dltc]") int measres1dltc,
            @Field("measres[1][bgc]") int measres1bgc,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[2][pkpot]") int measres2pkpot,
            @Field("measres[2][dltc]") int measres2dltc,
            @Field("measres[2][bgc]") int measres2bgc,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[3][pkpot]") int measres3pkpot,
            @Field("measres[3][dltc]") int measres3dltc,
            @Field("measres[3][bgc]") int measres3bgc,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[4][pkpot]") int measres4pkpot,
            @Field("measres[4][dltc]") int measres4dltc,
            @Field("measres[4][bgc]") int measres4bgc,
