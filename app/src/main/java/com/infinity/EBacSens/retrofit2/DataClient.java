...
public interface DataClient {
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[0][pkpot]") float measres0pkpot,
            @Field("measres[0][dltc]") float measres0dltc,
            @Field("measres[0][bgc]") float measres0bgc,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[1][pkpot]") float measres1pkpot,
            @Field("measres[1][dltc]") float measres1dltc,
            @Field("measres[1][bgc]") float measres1bgc,
            @Field("measres[1][err]") int measres1err,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[2][pkpot]") float measres2pkpot,
            @Field("measres[2][dltc]") float measres2dltc,
            @Field("measres[2][bgc]") float measres2bgc,
            @Field("measres[2][err]") int measres2err,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[3][pkpot]") float measres3pkpot,
            @Field("measres[3][dltc]") float measres3dltc,
            @Field("measres[3][bgc]") float measres3bgc,
            @Field("measres[3][err]") int measres3err,
    ...
    Call<SensorMeasure> storeMeasure(
            ...
            @Field("measres[4][pkpot]") float measres4pkpot,
            @Field("measres[4][dltc]") float measres4dltc,
            @Field("measres[4][bgc]") float measres4bgc,
            @Field("measres[4][err]") int measres4err,
