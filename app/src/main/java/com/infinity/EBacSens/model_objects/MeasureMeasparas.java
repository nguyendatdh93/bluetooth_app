...
public class MeasureMeasparas {
    ...
    @SerializedName("bac")
    @Expose
    private ArrayList<BacSetting> arrBac = new ArrayList<>();

    public MeasureMeasparas() {
    }
    ...
    public ArrayList<BacSetting> getArrBac() {
        return arrBac;
    }

    public void setArrBac(ArrayList<BacSetting> arrBac) {
        this.arrBac = arrBac;
    }
